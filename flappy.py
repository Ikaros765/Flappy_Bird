...
PLAYER2='Gallary/sprites/bird3.png'
BACKGROUND = 'Gallary/sprites/background-day.png'
PIPE = 'Gallary/sprites/pipe-green.png'
...
def mainGame():
    ...
    while True:
        ...
        if i%2==0:
            ...
            SCREEN.blit(GAME_SPRITES['player2'], (playerx, playery))
...
if __name__ == "__main__":
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('Gallary/Audio/audio_die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('Gallary/Audio/audio_hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('Gallary/Audio/audio_point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('Gallary/Audio/audio_swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('Gallary/Audio/audio_wing.wav')
